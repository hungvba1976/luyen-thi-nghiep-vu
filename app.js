...
const APP_VERSION = "Mobile V1.3.0 FINAL CLEAN";
const APP_BUILD_ID = "v1.3.0-final-clean";
...
function showPracticeFinishConfirm(){
  ...
  if(c.blank===0){finishPracticeSession();return;}
  ...
  $("#finishAnyway").onclick=finishPracticeSession;
